...
Acura NEXERA Vision, Lamborghini Revuelto SV, Lucid Gravity GT-S는 첫 추적 단계이므로 각 Brand Wiki의 모델 섹션에서 관리한다. 반복 등장·안전 추적·복수 Topic 연결 시 `models/*.md`로 승격한다.
